  ...
  ru: {
    ...
    dev: {
      ...
      flow: [
        ...
        { title: "Интеграция", body: "Настройте ключи доступа и Webhook URL в панели." },
        { title: "Запуск", body: "Начните принимать автоматические платежи через API." },
      ],
    },
    enterprise: {
      ...
      flow: [
        { title: "Активация", body: "Выберите Enterprise и подтвердите платежную ссылку." },
        { title: "Масштаб", body: "Лимиты обновляются сразу на всем аккаунте организации." },
        { title: "Поддержка", body: "Приоритетная линия связи для решения технических вопросов." },
      ],
    },
  },
  en: {
