...
const COPY = {
  ru: {
    ...
    copied: "Скопировано",
    warning: "Пожалуйста, отправляйте точную сумму в указанной сети для автоматического зачисления.",
    payloadTitle: "Обязательный комментарий",
    payloadHint: "Без него система не сможет распознать ваш платеж.",
    qrLoading: "QR-код...",
  ...
  en: {
    ...
    copyAmount: "Copy",
    copied: "Copied",
    warning: "Please send the exact amount in the specified network for automatic confirmation.",
    payloadTitle: "Required comment",
    payloadHint: "Without this comment, the system won't be able to match your payment automatically.",
    qrLoading: "QR...",
