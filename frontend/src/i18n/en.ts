...
// Signed event verification for payment webhooks`
  ...
  auth: {
    browserTitle: "Continue in recv",
    browserBody: "Use your Telegram account to finish setup and open the payment workspace.",
    continueGoogle: "Continue with Google",
    continueGithub: "Continue with GitHub",
    telegramFallback: "other sign-in options",
    ...
    browserHint: "Start the bot to get a one-time code. Inside Telegram, recv signs you in automatically.",
  ...
  sellerConsole: {
    ...
    overview: {
      ...
      setupPlan: "Activate a paid plan when you are ready to accept payments without trial limits.",
      setupPlanAction: "Choose Plan",
