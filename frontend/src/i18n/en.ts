      ...
      rails: [
        {
          ...
          body: "GRAM & USDT. The native choice for Telegram-based commerce and the growing TON ecosystem.",
        },
        {
          logo: "TRON",
          name: "TRON",
          title: "TRON Network",
          body: "USDT/TRC-20. The global standard for stablecoin settlement — high throughput, minimal fees.",
        },
        {
          logo: "SOLANA",
          name: "SOLANA",
          title: "Solana",
          body: "SOL, USDT & USDC. Sub-second finality with token-account-level monitoring.",
        },
        {
          logo: "BASE",
          name: "BASE",
          title: "Base",
          body: "USDT & USDC. Coinbase-backed L2 — ERC-20 log monitoring at confirmation depth.",
        },
        {
          logo: "ARBITRUM",
          name: "ARBITRUM",
          title: "Arbitrum",
          body: "USDT & USDC. Leading Ethereum L2 with deep liquidity and EVM-native tooling.",
        },
        {
          logo: "BSC",
          name: "BSC",
          title: "BNB Smart Chain",
          body: "BNB & USDT/BEP-20. High-volume chain with broad exchange support for fast withdrawals.",
        },
      ],
      soon: {
        title: "Coming Soon",
...
// Signed event verification for payment webhooks`
  ...
  auth: {
    browserTitle: "Sign in to Dashboard",
    browserBody: "Choose a convenient authorization method to access your dashboard.",
    continueGoogle: "Continue with Google",
    continueGithub: "Continue with GitHub",
    telegramFallback: "or sign in with Telegram",
    ...
    browserHint: "You can start our Telegram bot to quickly sign in with a one-time code.",
    termsDisclaimer: "By continuing, you confirm that you are at least 18 years old, are authorized to act on behalf of the Merchant, and agree to the Terms of Service and acknowledge the Privacy Policy.",
  ...
  sellerConsole: {
    nav: {
      ...
      upgrade: "Upgrade",
      activePlan: "Developer Active",
    },
    promo: {
      title: "Build without limits. Upgrade to Developer",
      subtitle: "Remove the 15-invoice cap. Automate your payments with high-performance REST APIs, secure webhooks, and native MCP tools for AI agents — directly to your wallets with zero platform fees.",
      action: "Go Developer",
    },
    overview: {
      welcome: "Welcome back,",
      subtitle: "Non-custodial payment gateway. Customer funds settle directly in your self-custody wallets.",
      badge: "Dashboard",
      ...
      setupWallet: "Set up your payout wallets. Customer funds will land directly in your custody.",
      setupWalletAction: "Configure Payouts",
      setupKey: "Create an API key to integrate recv into your backend.",
      setupKeyAction: "Create Key",
      setupInvoice: "Create a test invoice to experience our direct-to-wallet payment flow.",
      setupInvoiceAction: "Issue Test Invoice",
      setupPlan: "Go live without limits. Activate a plan for unlimited payments, API & webhooks.",
      setupPlanAction: "Unlock Pro & API",
      ...
      trialHudTitle: "Trial Plan Active",
      trialHudSubtitle: "You have {limit} free live invoices on Trial. Payments land directly in your wallet with 0% fees.",
      trialHudAction: "Go Unlimited",
      trialHudSaved: "Saved {amount} in processing fees so far",
      integrationHealthTitle: "Integration Health",
      integrationHealthPayouts: "Payout Destination",
      integrationHealthPayoutsConfigured: "TON, TRON direct addresses configured",
      integrationHealthPayoutsMissing: "Missing payout address",
      integrationHealthPayoutsAction: "Configure Payouts",
      integrationHealthWebhooks: "Webhooks Automation",
      integrationHealthWebhooksActive: "1 Endpoint active",
      integrationHealthWebhooksInactive: "No webhooks configured",
      integrationHealthWebhooksAction: "Configure Webhooks",
      integrationHealthApi: "API & MCP Access",
      integrationHealthApiActive: "{count} Active API key",
      integrationHealthApiActivePlural: "{count} Active API keys",
      integrationHealthApiInactive: "No active API keys",
      integrationHealthApiAction: "Create API Key",
      demoMode: "Show Demo Data",
      demoModeSubtitle: "Simulated dashboard preview",
      integrationHubTitle: "Developer Integration Hub",
      integrationHubSubtitle: "Configure your non-custodial environments to run live commerce operations.",
      sandboxToggle: "Preview Sandbox Data",
      invoiceTested: "First invoice issued and tested",
      invoiceMissing: "Create a test invoice to verify checkout",
      invoiceAction: "Create Invoice",
    },
    wallets: {
      ...
      invalidFormat: "Invalid address format for {network}",
    },
    invoices: {
      ...
      created: "Created",
      received: "Received",
      metricsVolume: "Total Volume",
      metricsCompleted: "Completed Invoices",
      metricsPending: "Pending Invoices",
    ...
    team: {
      ...
      locked: "Team Management is available on Business plan.",
      lockedSub: "Invite teammates, manage roles, and collaborate in your workspace. Upgrade to Business plan to unlock team features.",
      lockedAction: "Upgrade to Business",
    },
    billing: {
