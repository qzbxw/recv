const ru = {
    ...
    mcp: {
      ...
      body: "Reqst поставляет сервер Model Context Protocol — агенты вроде Claude и Cursor создают инвойсы, проверяют статус оплаты и валидируют вебхуки автономно, без связующего кода.",
      tools: [
  ...
  marketing: {
    ...
    common: {
      ...
      engineered: "Прямое зачисление на кошельки, подписанные вебхуки и нулевая комиссия с оборота в TON, TRON, Solana и EVM.",
    ...
    mcpProduct: {
      metadata: {
        ...
        description: "Подключите AI-агентов к Reqst через Model Context Protocol. Автономная настройка воркспейса, покупка плана, создание инвойсов и управление вебхуками — всё через LLM.",
        keywords: "mcp крипто платежи, model context protocol платежи, ai агент платежи, llm инвойс, автономные платежи, claude mcp reqst"
      },
      kicker: "AI-NATIVE",
      title: "Платежи для эпохи агентов",
      description: "Первая крипто-инфраструктура для AI-агентов. Reqst MCP позволяет любому Claude, GPT или кастомному LLM создать воркспейс, подписаться на план и начать принимать платежи без участия человека.",
      hero: {
        title: "Ваш AI-агент теперь крипто-мерчант.",
        body: "Reqst — первая платежная платформа с нативным MCP-сервером. Любой MCP-совместимый агент может онбординговаться, подписаться, создавать инвойсы и проверять вебхуки без дашборда.",
        ...
        items: [
          {
            ...
            reqst: "bootstrap_agent_workspace создаёт воркспейс и возвращает access token за один вызов."
          },
          {
            legacy: "LLM не могут нативно создавать и проверять платежные инвойсы.",
            reqst: "create_invoice и get_invoice — полноценные MCP-инструменты, которые агент вызывает напрямую."
          },
          {
            legacy: "Проверка подписи вебхука требует ручного кода на бекенде и работы с секретами.",
            reqst: "verify_webhook работает локально в MCP-процессе — ни сетевых запросов, ни утечки секретов."
          }
        ]
      },
      bento: {
      ...
      deepDive: [
        {
          ...
          body: "AI-агент может полностью зарегистрироваться в Reqst без каких-либо действий человека: вызывает bootstrap_agent_workspace, получает access token, покупает Developer или Business-подписку через create_subscription_checkout, поллит get_checkout_invoice до оплаты, затем выдаёт себе API-ключ. Весь флоу — последовательность MCP-вызовов."
        },
        {
          title: "Любой MCP-совместимый рантайм",
          body: "MCP-сервер Reqst работает через stdio и поддерживает Claude Desktop, Claude Code, Cursor, Cline, Continue и любой другой хост, реализующий спецификацию Model Context Protocol. Добавьте его в mcp.json с REQST_API_KEY и REQST_ACCESS_TOKEN — и ваш агент сразу получает платежные суперсилы."
        },
        {
      ...
      seo: "Интеграция Reqst MCP (Модель Контекстного Протокола) позволяет AI-агентам и LLM-приложениям автономно управлять полным циклом криптоплатежей. Агенты в Claude Desktop, Claude Code, Cursor или любом другом MCP-совместимом хосте могут вызывать bootstrap_agent_workspace для саморегистрации, покупать подписку, генерировать API-ключи, создавать инвойсы, регистрировать webhook-эндпойнты и проверять подписи вебхуков локально. Reqst — первая платежная инфраструктура, нативно разработанная для агентной эпохи автономного ПО."
    },
    productsHub: {
    ...
    networkPages: {
      ...
      arbitrum: {
        ...
        assets: {
          kicker: "SUPPORTED ASSETS",
          title: "USDT в сети Arbitrum.",
          body: "Используйте Arbitrum для клиентов, которым нужны Ethereum-совместимые платежи с низкими комиссиями.",
          items: [
            { name: "USDT on Arbitrum", body: "Переводы USDT в сети Arbitrum One для масштабируемых и дешевых долларовых транзакций." },
          ],
        },
        why: {
          kicker: "WHY ARBITRUM",
    ...
    compareHub: {
      ...
      description: "Сравните Reqst с ручной проверкой и кастодиальными шлюзами: прямое зачисление на кошельки, нулевая комиссия с оборота, подписанные вебхуки и семь поддерживаемых сетей.",
      kicker: "СРАВНЕНИЕ",
      items: [
        { title: "Reqst vs Ручная проверка", slug: "reqst-vs-manual", body: "Узнайте, как автоматизация устраняет человеческий фактор и масштабирует ваш бизнес." },
        { title: "Reqst vs Кастодиальные шлюзы", slug: "reqst-vs-custodial", body: "Почему non-custodial инфраструктура безопаснее и выгоднее для вашего бизнеса." },
        { title: "Reqst vs NowPayments", slug: "nowpayments", body: "Прямое сравнение комиссий, контроля и гибкости интеграции." },
      ]
    },
    comparePages: {
      "reqst-vs-manual": {
        name: "Ручные платежи",
        title: "Reqst vs Ручные платежи: Зачем автоматизировать?",
        description: "Сравнение автоматизированного процессинга с ручным отслеживанием кошельков. Узнайте, как Reqst исключает ошибки и масштабирует операции.",
        kicker: "АВТОМАТИЗАЦИЯ",
        points: [
          {
            title: "Масштабируемость",
            competitor: "Невозможно масштабировать. Каждая транзакция требует ручной проверки и ручного учета.",
            reqst: "Полная автоматизация. Обрабатывайте тысячи инвойсов одновременно с мониторингом в реальном времени и вебхуками."
          },
          {
            title: "Точность",
            competitor: "Высокий риск ошибок. Опечатки в адресах, пропущенные платежи или переводы не в той сети.",
            reqst: "Нулевой риск. Автоматическое сопоставление сумм и уникальных идентификаторов платежа."
          },
          {
            title: "Опыт покупателя",
            competitor: "Долго и неудобно. Клиенты ждут часы, пока менеджер подтвердит оплату и выдаст товар.",
            reqst: "Мгновенный результат. Детекция в реальном времени обеспечивает моментальную выдачу доступа или товара."
          }
        ]
      },
      "reqst-vs-custodial": {
        name: "Кастодиальные шлюзы",
        title: "Reqst vs Кастодиальные шлюзы: Преимущества Non-Custodial",
        description: "Зачем платить 1-3% комиссии и рисковать средствами? Сравните инфраструктуру Reqst с традиционными процессорами.",
        kicker: "СУВЕРЕНИТЕТ",
        points: [
          {
            ...
            reqst: "100% Non-custodial. Средства идут напрямую на ваш кошелек. Мы никогда не касаемся ваших денег."
          },
          {
            title: "Структура комиссий",
            competitor: "Переменные комиссии (1-3%). Ваши расходы растут вместе с бизнесом, съедая маржу.",
            reqst: "Фиксированная подписка. 0% с оборота. Предсказуемые расходы независимо от объема транзакций."
          },
          {
            title: "Комплаенс и приватность",
            competitor: "Строгие требования KYC/KYB и передача данных. Зависимость от политики третьих лиц.",
            reqst: "Приватная инфраструктура. Вы сами управляете отношениями со своими пользователями."
          }
        ]
      },
      "nowpayments": {
        name: "NowPayments",
        title: "Reqst vs NowPayments: Контроль против Удобства",
        ...
        points: [
          {
            ...
            reqst: "Атомарные выплаты. Каждая транзакция попадает на ваш кошелек сразу после подтверждения в сети."
          },
          {
            title: "Комиссия",
            competitor: "От 0.5% + сетевые комиссии. Высокий оборот означает высокие абсолютные затраты.",
            reqst: "0% комиссии. Оплачивается только фиксированная подписка и стандартный газ в блокчейне."
          },
          {
            title: "Интеграция",
            competitor: "Закрытое API и стандартные плагины. Фокус на универсальные e-commerce платформы.",
            reqst: "Протокол для разработчиков. Оптимизирован для SaaS, Telegram Mini Apps и кастомных систем."
          }
        ]
      }
    },
