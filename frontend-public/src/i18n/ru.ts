const ru = {
    hero: {
      ...
      badges: ["Выплаты на кошелек", "0% комиссия с оборота", "Non-Custodial API", "Без KYC верификации"],
    },
    heroPanel: {
  ...
  marketing: {
        ...
        items: [
          {
            ...
            recv: "QR-native поток и deep-linking в один тап гарантируют 100% точность."
          },
          {
            legacy: "Клиенты минутами ждут подтверждения на экране ожидания.",
            recv: "Мониторинг мемпула дает визуальный отклик менее чем за секунду."
          },
          {
      ...
      deepDive: [
        {
          ...
          body: "Недоплаты — причина №1 обращений в поддержку. recv решает это, обнаруживая частичную сумму, мгновенно обновляя интерфейс и предлагая клиенту доплатить остаток без потери прогресса. Больше никаких потерянных заказов и ручных возвратов."
        },
        {
    ...
    apiProduct: {
      metadata: {
        ...
        description: "Высокопроизводительная крипто-инфраструктура для разработчиков. Один API для TON, TRC-20, Base и BSC с 100% доставкой вебхуков и HMAC защитой.",
      ...
      comparison: {
        ...
        items: [
          ...
          },
          {
            ...
            recv: "Гарантированная доставка с экспоненциальной задержкой и HMAC."
          },
          {
            legacy: "Дублирование обработки одной и той же транзакции.",
            recv: "Встроенные ключи идемпотентности для обработки 'точно один раз'."
          }
        ]
      },
      bento: {
    ...
    compareHub: {
      ...
      description: "Сравните recv с ручной проверкой и кастодиальными шлюзами: прямое зачисление на кошельки, нулевая комиссия с оборота, подписанные вебхуки и семь поддерживаемых сетей.",
      kicker: "СРАВНЕНИЕ",
      items: [
    ...
    comparePages: {
        ...
        points: [
          {
            ...
            recv: "Полная автоматизация. Обрабатывайте тысячи инвойсов одновременно с мониторингом в реальном времени и вебхуками."
          },
          {
            title: "Точность",
            competitor: "Высокий риск ошибок. Опечатки в адресах, пропущенные платежи или переводы не в той сети.",
            recv: "Нулевой риск. Автоматическое сопоставление сумм и уникальных идентификаторов платежа."
          },
          {
            title: "Опыт покупателя",
            competitor: "Долго и неудобно. Клиенты ждут часы, пока менеджер подтвердит оплату и выдаст товар.",
            recv: "Мгновенный результат. Детекция в реальном времени обеспечивает моментальную выдачу доступа или товара."
          }
        ]
      },
      "recv-vs-custodial": {
        ...
        description: "Зачем платить 1-3% комиссии и рисковать средствами? Сравните инфраструктуру recv с традиционными процессорами.",
        kicker: "СУВЕРЕНИТЕТ",
        points: [
          {
          ...
          },
          {
            ...
            competitor: "Переменные комиссии (1-3%). Ваши расходы растут вместе с бизнесом, съедая маржу.",
      ...
      "nowpayments": {
        ...
        points: [
          ...
          {
            title: "Комиссия",
            competitor: "От 0.5% + сетевые комиссии. Высокий оборот означает высокие абсолютные затраты.",
      ...
      "coinbase-commerce": {
        ...
        description: "Coinbase Commerce хранит ваши средства на внутреннем аккаунте. recv отправляет каждый платёж напрямую на ваш кошелёк в момент подтверждения транзакции — без запросов на вывод и без рисков третьей стороны.",
        kicker: "КАСТОДИЯ",
        points: [
          {
            title: "Хранение средств",
            competitor: "Coinbase удерживает балансы от вашего имени. Вывод требует ручных запросов и подчиняется политике Coinbase, включая риск заморозки аккаунта.",
          ...
          },
          {
            ...
            competitor: "Комиссия 1% со всех платежей. При масштабировании это становится значительной регулярной статьёй расходов, привязанной к выручке.",
          ...
          },
          {
            ...
            competitor: "Ограничено сетями Coinbase. Нет TON, ограниченная поддержка TRON, никаких Telegram-нативных платёжных потоков.",
            recv: "Семь сетей: TON, TRON, Solana, Base, Arbitrum и BSC — с полноценной поддержкой Telegram Mini App."
          }
        ]
      },
      "bitpay": {
        ...
        description: "BitPay берёт 1% с каждой транзакции. recv заменяет это фиксированной ежемесячной подпиской и 0% с оборота — предсказуемые расходы, которые не растут против вас.",
        kicker: "КОМИССИИ",
        points: [
          {
            title: "Структура расходов",
            competitor: "Комиссия 1% плюс сетевые затраты на расчёт. Высокообъёмные мерчанты ежемесячно платят тысячи в виде чистых комиссий.",
          ...
          },
          {
            ...
            competitor: "BitPay выполняет расчёты по дневному или недельному циклу на банковский счёт или внутренний кошелёк, добавляя задержку и валютный риск.",
          ...
          },
          {
            ...
            recv: "Открытый API с вебхуками, онбординг без KYC и полный программный контроль. Готово к продакшену за несколько минут."
          }
        ]
      },
      "coingate": {
