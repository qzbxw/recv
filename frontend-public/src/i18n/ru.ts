const ru = {
  ...
  marketing: {
    ...
    checkoutProduct: {
      metadata: {
        title: "Прием платежей в криптовалюте | Non-custodial чекаут для TON, TRON, Solana",
        description: "Масштабируйте бизнес с высококонверсионным крипто-чекаутом. Поддержка USDT (TRC-20, TON, Solana, EVM) с 0% комиссии с оборота. Безопасно и готово для Telegram.",
        keywords: "прием платежей криптовалюта, крипто эквайринг, оплата в TON, прием USDT TRC20, Solana чекаут, некастодиальный платежный шлюз, прием крипты в телеграм, api для оплаты криптовалютой"
      },
      ...
      seo: "Reqst Checkout — это некастодиальный платежный шлюз, спроектированный для обеспечения высокой конверсии при приеме криптовалют. Интерфейс поддерживает прямые (direct-to-wallet) транзакции в сетях TON, TRON (TRC-20), Solana и EVM. Базовый функционал включает динамический расчет курсов, нативную интеграцию с Telegram Mini Apps (TWA) и алгоритмы автоматической обработки недоплат для сохранения частичных транзакций. Отказ от посредников позволяет мерчантам сохранять полный контроль над ликвидностью, предлагая клиентам бесшовный мультичейн-опыт без скрытых комиссий с оборота."
    },
    apiProduct: {
      metadata: {
        title: "Единый Blockchain API | Мониторинг и Вебхуки для TON, TRON, EVM",
        description: "Высокопроизводительная крипто-инфраструктура для разработчиков. Один API для TON, TRC-20, Solana и EVM с 100% доставкой вебхуков и HMAC защитой.",
      ...
      seo: "Унифицированный API Reqst предоставляет отказоустойчивую инфраструктуру для интеграции блокчейн-платежей в B2B-продукты, игровые сервисы и корпоративные системы. Вместо поддержки зоопарка RPC-нод, разработчики получают единый REST-интерфейс для работы с протоколами TRON, TON и Ethereum. Платформа обеспечивает строгую транзакционную целостность благодаря ключам идемпотентности, исключающим двойные списания. Система вебхуков гарантирует надежную доставку событий за счет алгоритмов экспоненциальной задержки (exponential backoff) и криптографической подписи HMAC-SHA256."
    },
    invoicingProduct: {
      metadata: {
        title: "Профессиональный крипто-инвойсинг | B2B биллинг без комиссий",
        description: "Выставляйте и управляйте профессиональными крипто-счетами. Поддержка USDT, TON и Solana. Автоматический трекинг и CSV-отчеты для бухгалтерии.",
    ...
    useCasesHub: {
      title: "Решения для любого масштаба бизнеса",
      description: "Узнайте, как различные индустрии используют Reqst для автоматизации своих крипто-операций и исключения ручных проверок.",
      kicker: "КЕЙСЫ",
      customUseCase: {
        title: "У вас уникальный сценарий?",
        body: "Наш API достаточно гибок, чтобы обеспечить любой платежный сценарий. Давайте обсудим, как Reqst может помочь вашему бизнесу.",
      }
    },
    useCasePages: {
      "telegram-shops": {
        ...
        hero: {
          title: "Прием платежей в криптовалюте для Telegram ботов и Mini Apps",
          body: "Reqst предоставляет высокопроизводительный Checkout, мониторинг блокчейна в реальном времени и прямые выплаты для нативной коммерции в Telegram.",
        },
        snapshot: {
          kicker: "ЖИВОЙ ЗАКАЗ",
        ...
        solution: {
          ...
          body: "Генерируйте защищенные ссылки на оплату для каждого заказа. Вотчеры Reqst мониторят блокчейн 24/7, переводя заказы в статус «оплачено» сразу после подтверждения транзакции.",
        },
        productPlan: {
        ...
        flow: {
          ...
          steps: [
            ...
            { title: "Перевод найден", body: "Вотчеры Reqst обнаруживают транзакцию в сети и мгновенно сверяют сумму." },
        ...
        related: {
          ...
          links: [
            { kicker: "Сеть", label: "Поддержка TON", body: "Нативные платежные рельсы для Telegram Mini Apps.", href: "/networks/ton" },
        ...
        cta: {
          ...
          body: "Хватит проверять скриншоты. Доверьте Reqst мониторинг блокчейна, пока вы фокусируетесь на масштабировании бизнеса.",
          primary: { label: "Начать прием платежей", href: "/app/auth" },
          secondary: { label: "Изучить Checkout", href: "/products/checkout" },
        },
        features: ["Поддержка TON и Jettons", "Статусы заказов в реальном времени", "Выплаты Direct-to-Wallet", "Оптимизация под Telegram Mini App"],
        seoLabel: "Документация по криптоплатежам для Telegram-магазинов",
        seo: "Reqst позволяет магазинам в Telegram принимать платежи в криптовалюте с помощью готовых ссылок, поддержки TON, стейблкоинов, прямых выплат и автоматической детекции транзакций.",
      },
      "saas-billing": {
        name: "SaaS биллинг",
        metadata: {
          title: "Инфраструктура крипто-биллинга для SaaS платформ",
          description: "Внедрите надежный крипто-биллинг для SaaS подписок. Поддержка TON, TRON и EVM со 100% доставкой вебхуков и защитой HMAC.",
        },
        kicker: "ИНФРАСТРУКТУРА SAAS",
        hero: {
          title: "Крипто-биллинг корпоративного уровня для SaaS",
          body: "Забудьте о комиссиях с оборота. Reqst предоставляет API-примитивы для идемпотентного создания инвойсов и гарантированной доставки вебхуков.",
        },
        snapshot: {
        ...
        productPlan: {
          ...
          product: {
            label: "Продукт",
            title: "API и вебхуки",
            body: "Идемпотентное создание счетов и гарантированная доставка событий для биллинг-систем продакшен-уровня.",
            href: "/products/api",
        ...
        networks: {
          ...
          body: "Используйте USDT (TRC-20) для стабильности бизнеса или добавьте Base и Arbitrum для снижения стоимости транзакций в экосистеме Ethereum.",
          items: [
            { name: "TRON USDT", body: "Индустриальный стандарт для расчетов в стейблкоинах с привязкой к USD." },
            { name: "Base / Arbitrum", body: "Оптимизированные L2-сети для недорогих платежей в экосистеме Ethereum." },
            { name: "TON / Solana", body: "Высокопроизводительные варианты для web3-аудитории." },
          ],
        },
        flow: {
          kicker: "ПРОЦЕСС ИНТЕГРАЦИИ",
          ...
          steps: [
            { title: "Инвойс выпущен", body: "Ваш биллинг-сервис создает инвойс в Reqst с ключом идемпотентности." },
        ...
        seo: "Reqst предоставляет SaaS-платформам надежную инфраструктуру для крипто-биллинга с идемпотентными вызовами, HMAC-вебхуками и поддержкой TON, TRON и EVM без комиссий с оборота.",
      },
      "digital-goods": {
        ...
        hero: {
          ...
          body: "Автоматизируйте доставку лицензий, ключей и файлов. Reqst запускает процесс выдачи сразу после подтверждения транзакции в блокчейне.",
        },
        snapshot: {
          kicker: "FULFILLMENT",
        ...
        solution: {
          ...
          body: "Объедините наш конверсионный Checkout с автоматикой выдачи. Reqst берет на себя мониторинг платежа, ваш сервер — доставку товара.",
        },
        productPlan: {
          kicker: "ПРОДУКТ И ТАРИФ",
        ...
        networks: {
          ...
          items: [
            ...
            { name: "Solana", body: "Быстрый мониторинг для мгновенных цифровых продаж." },
          ],
        },
        flow: {
          kicker: "ПРОЦЕСС ИНТЕГРАЦИИ",
          ...
          steps: [
            ...
            { title: "Оплата подтверждена", body: "Вотчеры Reqst обнаруживают транзакцию и сверяют её с заказом." },
        ...
        cta: {
          ...
          body: "Переходите на Reqst для работы без комиссий с оборота и получения мгновенных сигналов к выдаче товара.",
        ...
        seo: "Reqst обеспечивает автоматизированный крипто-чекаут для цифровых товаров с мгновенной выдачей через вебхуки, мультичейн-мониторингом и прямыми выплатами без комиссий.",
      },
      "paid-communities": {
        name: "Закрытые сообщества",
        metadata: {
          title: "Прием криптовалюты для закрытых сообществ и каналов",
          description: "Управляйте доступом в Telegram-каналы и группы через автоматические крипто-платежи. Поддержка TON, USDT и Solana.",
        },
        kicker: "ЭКОНОМИКА ПОДПИСОК",
        hero: {
          title: "Автоматизированный доступ в закрытые сообщества",
          body: "Свяжите on-chain платежи с доступом в сообщество. Reqst предоставляет инфраструктуру для мониторинга подписок и автоматической выдачи прав.",
        },
        snapshot: {
          kicker: "ACCESS EVENT",
        ...
        solution: {
          ...
          body: "Используйте Reqst для мгновенной проверки оплат за участие. Наши события могут управлять вашим ботом для приглашения или удаления участников.",
        },
        productPlan: {
          kicker: "ПРОДУКТ И ТАРИФ",
        ...
        networks: {
          kicker: "СЕТИ",
          title: "TON — приоритет для Telegram-сообществ",
          body: "TON — нативный выбор для пользователей Telegram, а TRON USDT — надежный вариант для глобальных подписчиков.",
          items: [
            ...
            { name: "Base / Arbitrum", body: "Идеально для web3-групп и децентрализованных организаций." },
          ],
        },
        flow: {
          kicker: "ПРОЦЕСС ИНТЕГРАЦИИ",
          ...
          steps: [
            ...
            { title: "Checkout открыт", body: "Reqst генерирует уникальный запрос с данными сети и актива." },
        ...
        related: {
          ...
          links: [
            { kicker: "Сеть", label: "Поддержка TON", body: "Нативные рельсы для подписок в Telegram.", href: "/networks/ton" },
        ...
        seo: "Reqst позволяет платным сообществам принимать крипто за доступ в Telegram-каналы и группы, предлагая поддержку TON, автоматизацию через вебхуки и 0% комиссии с оборота.",
      },
    },
    compareHub: {
