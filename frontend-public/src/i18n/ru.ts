const ru = {
    ...
    pricing: {
      ...
      merchant: {
        ...
        features: ["Безлимитные продажи", "Ручное подтверждение", "0% комиссия (Direct-to-Wallet)", "Basic Analytics"],
        cta: "Начать работу"
      },
      developer: {
        name: "Developer",
        price: "199",
        features: ["Полный API & Webhooks", "50k запросов/мес", "3 Seat / 3 Workspace", "Standard Support"],
        cta: "Подробнее"
      },
      business: {
        name: "Business",
        price: "499",
        features: ["200k запросов/мес", "10 Seat / 10 Workspace", "Advanced Analytics", "Priority Support"],
        cta: "Подробнее"
      },
      enterprise: {
        name: "Enterprise",
        price: "Custom",
        features: ["1M+ запросов/мес", "Unlimited Seats", "B2B / SLA", "Dedicated Support"],
        cta: "Связаться"
      }
    },
    faq: {
