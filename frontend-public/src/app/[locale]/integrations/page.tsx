...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const copy = getStaticPageCopy("integrations", locale);
  return {
...
export default async function Page({ params }: Props) {
  ...
  return <StaticMarketingPage locale={locale} path="/integrations" copy={getStaticPageCopy("integrations", normalizedLocale)} />;
}
