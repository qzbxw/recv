...
All endpoints below live under `https://recv.money/v1` and require an [API key](/en/docs/authentication).
...
| `payable_network` | string | Yes | One of `TON`, `TON_USDT`, `TRON`, `BASE`, `BSC`. You must have an active payout wallet for the matching wallet bucket. |
