...
API access requires a paid plan with the developer API enabled (**Developer** or **Business** — the Merchant and Trial plans do **not** include the API). See [Authentication](/en/docs/authentication) and [Errors](/en/docs/errors) for plan limits.
...
- [MCP / AI Agents](/en/docs/mcp) — drive recv from an AI agent.
